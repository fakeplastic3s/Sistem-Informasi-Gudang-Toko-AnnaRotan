...
class Pengadaan extends BaseController
{
    ...
    public function laporan()
    {
        ...
        if ($tanggal_awal && $tanggal_akhir) {
            $Pengadaan['laporan'] = $model->laporan($tanggal_awal, $tanggal_akhir);
            $Pengadaan['title'] = 'Laporan Pengadaan Barang';
            echo view('/pengadaan/laporanPengadaan', $Pengadaan);
        } else {
            $Pengadaan['laporan'] = $model->laporan(0, 0);
            $Pengadaan['title'] = 'Laporan Pengadaan Barang';
            echo view('/pengadaan/laporanPengadaan', $Pengadaan);
        }
    }
