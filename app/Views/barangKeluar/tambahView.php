...
<div class="card">
    <div class="card-body">
        ...
        <form action="/BarangKeluar/add" method="POST">
            <?= csrf_field(); ?>
                ...
                <div class="col-sm-9">
                    <select name="supplier" class="select2_single form-control <?= ($validation->hasError('supplier')) ? 'is-invalid' : ''; ?>" value="<?= old('supplier'); ?>">
                        ...
                        <?php foreach ($supplier as $row) : ?>
                            <option value="<?= $row['id_supplier']; ?>" <?php if (old('supplier') == $row['id_supplier']) echo 'selected'; ?>> <?= $row['nama_barang']; ?> -
            ...
            <div class="row mb-3">
                <label for="tanggal" class="col-sm-3 col-form-label">Tanggal Barang Keluar</label>
                <div class="col-sm-9">
