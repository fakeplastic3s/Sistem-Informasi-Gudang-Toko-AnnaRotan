...
<section class="section dashboard">
    ...
    <div class="row ">
        <div class="col-lg-2 col-sm-4 col-md-4 ms-2">
            ...
            <a href="<?= base_url('BarangKeluar/laporan'); ?>" class="btn btn-secondary mb-2"><i class="bi bi-arrow-clockwise"></i></a>
        </div>
        <div class="col me-2">

            <form class="d-flex" role="search" action="<?= base_url('BarangKeluar/laporan'); ?>" method="POST">
                <!-- date 1 -->
                ...
                <div class="input-group mb-3 mx-2">
                    ...
                    <input type="date" class="form-control" name="tanggal2" aria-label="Username" aria-describedby="basic-addon2" required>
                </div>
                        ...
                        <?php foreach ($laporan as $isi) : ?>
                            <tr class="text-center">
                                ...
                                <td class="text-center">
                                    <?php
                                    $tanggal = date('d M Y', strtotime($isi['tgl_keluar']));
                                    echo $tanggal
                                    ?>
                                </td>
                            </tr>
